"""Run the configured five-trial batch using the installed Python 3.8 solvers."""
...
sys.argv = [
    "test_nmpc.py", "-c", str(PROJECT / "config/config_nmpc_trials_maze_oblique.yaml"),
    "--trials", "5", "--results-dir", str(RESULTS),
]
