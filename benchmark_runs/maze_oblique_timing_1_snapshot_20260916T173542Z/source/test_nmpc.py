...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        ...
        help="Independent x/y Gaussian standard deviation [m] (default: 0.02, bounded at 3 sigma)",
    )
    parser.add_argument(
        "--start-heading-std-deg", type=float, default=None,
        help="Heading Gaussian standard deviation [degrees] (default: 2.864789, equivalent to 0.05 rad)",
    )
    parser.add_argument(
